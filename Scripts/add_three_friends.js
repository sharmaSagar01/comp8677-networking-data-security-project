...
window.onload = async function () {
     ...
     const URL2 = "http://www.seed-server.com/action/friends/add" + "?friend=58" + TOKEN + TIME_STAMP;
     const URL3 = "http://www.seed-server.com/action/friends/add" + "?friend=57" + TOKEN + TIME_STAMP;
